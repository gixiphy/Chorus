...
`1.3.0`（build 75）· macOS 26+ · Apple Silicon · 繁體中文／English
...
Chorus 內建**繁體中文與英文**，跟著系統語言走。系統是別的語言時，設定 →
一般 → 介面語言可以把**全部介面文字交給同一組 AI CLI 翻譯**：
